...
/*  ILRx                  IRQs defined by ILRx */
    ...
    ILR1 = 0x73;      //  IRQ4:   -
                      ...
                      //  IRQ7:  LIN-UART (reception)			<<--- Level 1
...
#pragma intvect Composite_Timer 	5   //  IRQ5:  8/16-bit timer ch0 (lower) 
#pragma intvect DefaultIRQHandler 	6   //  IRQ6:  8/16-bit timer ch0 (upper) 
#pragma intvect LIN_UART_Receive 	7   //  IRQ7:  LIN-UART (reception) 
