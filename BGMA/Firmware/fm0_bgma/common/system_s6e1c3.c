 ...
 **
 ** History:
 ** 16.12.2015 18:31:21 2.0 MISH Auto created by make sys_xxx.c script
 ******************************************************************************/
...
void SystemCoreClockUpdate (void) {
  ...
  //   "Unordered accesses to a volatile location"
      u32RegisterRead = (__CLKMO  * (((uint32_t)(FM_CRG->PLL_CTL2) & 0x1F) + 1u));
...
#if (CR_TRIM_SETUP)
  /* CR Trimming Data  */
  if( 0x007F03FF != (FM_FLASH_IF->CRTRMM & 0x007F03FF) )
  {
    /* UnLock (MCR_FTRM) */
