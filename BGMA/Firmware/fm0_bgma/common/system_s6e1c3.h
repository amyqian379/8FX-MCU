 ...
 **
 ** History: 
 ** 16.12.2015 18:31:28 2.0 MISH Auto created by make header script
 **
 **
 ...
 ** - 7 = (reserved)
 ******************************************************************************/    
#define BSC_PSR_Val           0x00000002ul    // <<< Define BSC_PSR here
 ...
 ** - 3 = SWDGOGCLK = PCLK0 / 8
 ******************************************************************************/  
#define SWC_PSR_Val           0x00000000ul    // <<< Define SWC_PSR here
 ...
 ** - 15 = ~2.0 s
 ******************************************************************************/     
#define CSW_TMR_Val           0x00000007ul    // <<< Define CSW_TMR here
 ...
 ** - 7 = ~16.40 ms
 ******************************************************************************/    
#define PSW_TMR_Val           0x00000007ul    // <<< Define PSW_TMR here
 ...
 ******************************************************************************/    
#define PLL_CTL1_Val           ( 0x00000000ul)   // <<< Define PLL_CTL1 here
 ...
 ******************************************************************************/    
#define PLL_CTL2_Val           ( 0x0000000bul)   // <<< Define PLL_CTL2 here
 ...
 **        <i>(USER SETTING)</i>
 ******************************************************************************/    
#define __CLKHC         ( 8000000ul)   // Internal 8MHzCR Oscillator 
