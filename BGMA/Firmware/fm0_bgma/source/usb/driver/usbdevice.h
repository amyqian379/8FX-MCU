...
typedef struct stc_usbdevice_class_config
{
    ...
    usbdevice_setuprequest_func_ptr_t pfnVendorRequestCallback; ///< Callback for vendor requests
...
typedef struct stc_usbdevice_intern_data
{
  ...
  stc_usbdevice_reportdescriptor_t* astcHIDDescriptors;                  ///< Pointer to USB HID descriptor struct array
  ...
  uint8_t* pu8MicrosoftOSDescriptors;                                    ///< Microsoft OS Descriptors (MODs)
  uint8_t* pu8MSOScompatibilityID;                                       ///< MS OS compatibility ID
  uint8_t* pu8ExtendedPrpertyDescriptor;                                 ///< Extended prperty descriptor
#endif
...
{
    uint8_t* pu8DeviceDescriptor;                                 ///< Pointer to USB device descriptor
    //uint8_t* pu8DeviceQualifierDescriptor;                        ///< Pointer to USB device qualifier descriptor
    uint8_t* pu8ConfigDescriptor;                                 ///< Pointer to USB configuration descriptor
    stc_usbdevice_reportdescriptor_t* astcHIDDescriptors;         ///< Pointer to USB HID descriptor struct array
    stc_usbdevice_reportdescriptor_t* astcReportDescriptors;      ///< Pointer to USB report descriptor struct array
