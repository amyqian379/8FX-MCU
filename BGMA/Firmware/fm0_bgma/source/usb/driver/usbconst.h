...
/* Microsoft OS descriptor string index. */
#define MS_OS_DSCR_STRING_INDEX         (0xEE)

/* Vendor command for MS OS descriptor request. */
#define CY_US_MS_OS_VENDOR_CMD         (0x05)

/* Compatibility ID request code. */
#define CY_US_OS_COMPATIBILITY_ID       (0x04)

/* Extended property descriptor request code. */
#define CY_US_OS_EXTENDED_PROP          (0x05)
