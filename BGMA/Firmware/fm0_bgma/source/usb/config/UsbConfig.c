...
static void UsbConfig_UsbDeviceClassesInitCallback0(stc_usbn_t* pstcUSB)
{
    ...
    #endif
    #if (USBDEVICEVENDOR_ENABLED == ON)
        UsbDeviceVendor_Init((stc_usbn_t*)&USB0);
    #endif
...
void UsbConfig_UsbInit(void)
{
    ...
    USB_ZERO_STRUCT(stcUsbConfig);
        ...
        stcUsbConfig.enMode = UsbDeviceEnabled;
            ...
            stcUsbDeviceConfig.astcHIDDescriptors = (stc_usbdevice_reportdescriptor_t*)astcHIDDescriptors;
            ...
            stcUsbDeviceConfig.u8StringDescriptorCount = USBDESCRIPTORS_STRINGDESCRIPTOR_COUNT;
                ...
                stcUsbDeviceConfig.pu8MicrosoftOSDescriptors = (uint8_t*)gl_ms_os_string;
                stcUsbDeviceConfig.pu8MSOScompatibilityID = (uint8_t*)gl_os_compatibility_id;
                stcUsbDeviceConfig.pu8ExtendedPrpertyDescriptor = (uint8_t*)gl_os_feature;
